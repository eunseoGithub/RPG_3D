...
//    private Dictionary<CharState, IState<CharacterController_2>> dicState = new Dictionary<CharState, IState<CharacterController_2>>();
//    private StateMachine<CharacterController_2> sm;

//    // Start is called before the first frame update
//    void Start()
//    {
//        characterSetting = this.GetComponent<Character>();
//        IState<CharacterController_2> idle = new CharacterIdle();
//        IState<CharacterController_2> move = new CharacterMove();
//        IState<CharacterController_2> attack = new CharacterAttack();

//        dicState.Add(CharState.Idle, idle);
//        dicState.Add(CharState.Move, move);
//        dicState.Add(CharState.Attack, attack);

//        sm = new StateMachine<CharacterController_2>(this, dicState[CharState.Idle]);
